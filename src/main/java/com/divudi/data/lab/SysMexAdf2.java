...
public class SysMexAdf2 {
    ...
    private int sampleIdEnd = 54;
    private int wbcStart = 55;
    private int wbcEnd = 60;
    private int rbcStart = 61;
    private int rbcEnd = 65;
    private int hgbStart = 66;
    private int hgbEnd = 70;
    private int hctStart = 71;
    private int hctEnd = 75;
    private int mcvStart = 76;
    private int mcvEnd = 80;
    private int mchStart = 81;
    private int mchEnd = 85;
    private int mchcStart = 86;
    private int mchcEnd = 90;
    private int pltStart = 91;
    private int pltEnd = 95;
    private int lymphPercentStart = 96;
    private int lymphPercentEnd = 100;
    private int monoPercentStart = 101;
    private int monoPercentEnd = 105;
    private int neuPercentStart = 106;
    private int neuPercentEnd = 110;
    private int eoPercentStart = 111;
    private int eoPercentEnd = 115;
    private int basoPercentStart = 116;
    private int basoPercentEnd = 120;
