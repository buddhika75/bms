...
//                Investigation tix = investigationController.getInvestigationByIdAndSetAsCurrent(tixi.getItem().getId());
                if (tixi.getItem().equals(currentInvestigation)) {
                    tixi.setTube(currentInvestigation.getInvestigationTube());
                    tixi.setSample(currentInvestigation.getSample());
                    tixi.setMachine(currentInvestigation.getMachine());
                    Item sc = itemController.getFirstInvestigationSampleComponents(currentInvestigation);
