...
public class OpdMemberShipDiscountController implements Serializable {
    ...
    public void saveSelectedChannelMembershipScheme() {
        ...
        getFacade().create(a);
        UtilityController.addSuccessMessage("Saved Successfully");
        createItemsChannelMembershipScheme();
        clearInstanceVars();
    ...
    public void createItemsChannelMembershipScheme() {
        filterItems = null;
        String sql;
        HashMap hm = new HashMap();
        sql = "select a from PaymentSchemeDiscount a "
                + " where a.retired=false"
                + " and a.membershipScheme=:pm "
                + " and a.category is null"
                + " and a.department is null "
                + " and a.billType=:bt "
                + " order by a.membershipScheme.name ";
