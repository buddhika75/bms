...
public class ApplicationController {
    ...
    private Long lastCodeGenerated;
...
//        sessionControllers.remove(sc);
    ...
    public String createNewPersonalHealthNumber(Institution ins) {
        ...
        String num = String.format("%06d", iln.patientCount);
    ...
    public Long getLastCodeGenerated() {
        return lastCodeGenerated;
    }

    public void setLastCodeGenerated(Long lastCodeGenerated) {
        this.lastCodeGenerated = lastCodeGenerated;
    }
