...
public class UserPrivilageController implements Serializable {
    ...
    private TreeNode createTreeNode() {
        ...
        TreeNode node227 = new PrivilageNode("Patient Details Edit", node2, Privileges.LabPatientDetailsEdit);
...
//////////////////
        ...
        TreeNode node707 = new PrivilageNode("Administration", node7);
        TreeNode node707a = new PrivilageNode("Administration", node707, Privileges.ClinicalAdministration);
        TreeNode node707b = new PrivilageNode("Edit Letter", node707, Privileges.ClinicalAdministrationEditLetter);
        TreeNode node708 = new PrivilageNode("Delete Patients", node7, Privileges.ClinicalPatientDelete);
        TreeNode node709 = new PrivilageNode("Edit Patient Details", node7, Privileges.ClinicalPatientEdit);
